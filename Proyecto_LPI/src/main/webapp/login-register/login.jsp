...
<body class="diagonal-line-bg vh-100 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="card-body p-4">
                        <form action="LoginServlet" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-lg" name="usuario" placeholder="Ingrese usuario" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label fw-bold">Password</label>
                                <input type="password" class="form-control form-control-lg" name="password" placeholder="Ingrese contraseña" required>
                            </div>
                            ...
                            <div class="text-center my-3">
								...
								<div class="d-grid gap-2">
								    <a href="GoogleLoginServlet" class="btn btn-google btn-lg" role="button">
